...
Anecdotal comment containing a lot of guesswork: How many nodes do you need? If I remember correctly, Airbnb's business front-end (the part that's a Rails monolith) uses 300-600 machines if I remember correctly. So I think 60-200 Elixir nodes would be enough to power a good portion of Airbnb, as you need far fewer servers to serve the equivalent amount of traffic in Phoenix than Rails.
