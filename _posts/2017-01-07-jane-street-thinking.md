...
Jane Street is a liquidity provider: they help the market run more smoothly and help people make trades. They operates entirely on public markets. They're a rare type of company that has no product to sell directly to external clients[^3]. Having little for salesmanship, it becomes much easier to eliminate the need for chest-thumping displays of confidence, which allows more honesty and directness. On the other hand, while Jane Street is one of the most open finance companies and routinely blogs about their tech stack, they can't quite match tech companies who are under significantly less scrutiny.
